// Carousel component (site-local copy of the engine's). Renders image slides + a thumbnail strip
// from an IMAGES array of web paths (a collection item's $images, passed via per-item component
// vars), using ALT for the alt text. The prev/next controls and indicators are injected
// client-side by script.js; Bootstrap (loaded by the layout) drives the sliding.
