// Carousel behaviour (site-local copy of the engine's). The build emits only slides + thumbnails;
// this injects the prev/next controls and indicators for any carousel with more than one slide
// (keeping that chrome out of the server markup), and wires thumbnail clicks. Bootstrap (loaded by
// the layout) performs the sliding.
